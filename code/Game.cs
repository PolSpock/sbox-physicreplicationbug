...
partial class SandboxGame : GameManager
{
	...
	public override void ClientJoined( IClient cl )
	{
		...
		cl.Pawn = player;
		player.SetupPhysicsFromAABB( PhysicsMotionType.Keyframed, new Vector3( -16, -16, 0 ), new Vector3( 16, 16, 32 ) );
	}
	...
	public static void test()
	{
		...
		{
			(client.Pawn as SandboxPlayer).SetupPhysicsFromAABB( PhysicsMotionType.Keyframed, new Vector3( -16, -16, 0 ), new Vector3( 16, 16, 72 ) );
		}
	}
